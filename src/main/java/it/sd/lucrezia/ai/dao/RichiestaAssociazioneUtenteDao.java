...
public class RichiestaAssociazioneUtenteDao {
	...
	public Long insertRichiestaDaVerificareAdmin(
			String telefonoNuovo,
			String nomeNuovo,
			String cognomeNuovo,
			String telefonoUtenteDichiarato,
			String nomeUtenteDichiarato,
			String cognomeUtenteDichiarato,
			String indirizzoCondominioDichiarato,
			String internoDichiarato,
			Long idTelefonata) {
		...
		String sql = """
				INSERT INTO richieste_associazione_utente (
				    ...
				    id_telefonata,
				    stato,
				    telefono_utente_dichiarato,
				    nome_utente_dichiarato,
				    cognome_utente_dichiarato,
				    indirizzo_condominio_dichiarato,
				    interno_dichiarato,
				    data_creazione
				)
				VALUES (
		...
		try (
			...
			ps.setString(
					5,
					telefonoUtenteDichiarato
					);

			ps.setString(
					6,
					nomeUtenteDichiarato
					);

			ps.setString(
					7,
					cognomeUtenteDichiarato
					);

			ps.setString(
					8,
					indirizzoCondominioDichiarato
					);
	...
	public Long findIdByTelefonata(
			Long idTelefonata) {
